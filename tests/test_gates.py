...
@mutates("FAL-PIN-VDU-SYMBOL-NO-UNIT")
def _pin_vdu_symbol_no_unit(data):
    _drop_first_symbol_unit(data, "PHY-PINNACLE-VECTOR-DIRECTION-UNIT")


@mutates("FAL-PIN-NFC-SYMBOL-NO-UNIT")
def _pin_nfc_symbol_no_unit(data):
