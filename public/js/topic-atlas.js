        ...
        activitiesHtml = `
          <div style="background: rgba(56, 189, 248, 0.08); border: 1px solid rgba(56, 189, 248, 0.4); border-radius: 6px; padding: 12px; margin-top: 12px;">
            <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 4px;">
              ...
              <strong style="color: #fff; font-size: 13px;">${r.activities[0].title}</strong>
            </div>
            <p style="font-size: 12px; color: var(--text-muted); margin-bottom: 8px;">
              ${r.activities[0].section || 'Interactive explorer canonically registered in library records.'}
            </p>
            <a href="${r.activities[0].locator}" class="btn primary-phy" style="font-size: 11px; padding: 4px 10px;">
              Launch Activity ↗
            </a>
          </div>
        `;
